...
// markup not found, no include::{specDir}application-link/POST/spec.adoc[opts=optional]
...
// markup not found, no include::{snippetDir}application-link/POST/http-request.adoc[opts=optional]


// markup not found, no include::{snippetDir}application-link/POST/http-response.adoc[opts=optional]



// file not found, no * wiremock data link :application-link/POST/POST.json[]


ifdef::internal-generation[]
===== Implementation

// markup not found, no include::{specDir}application-link/POST/implementation.adoc[opts=optional]
...
// markup not found, no include::{specDir}application-link/GET/spec.adoc[opts=optional]
...
// markup not found, no include::{snippetDir}application-link/GET/http-request.adoc[opts=optional]


// markup not found, no include::{snippetDir}application-link/GET/http-response.adoc[opts=optional]



// file not found, no * wiremock data link :application-link/GET/GET.json[]


ifdef::internal-generation[]
===== Implementation

// markup not found, no include::{specDir}application-link/GET/implementation.adoc[opts=optional]
...
// markup not found, no include::{specDir}application-link/PUT/spec.adoc[opts=optional]
...
// markup not found, no include::{snippetDir}application-link/PUT/http-request.adoc[opts=optional]


// markup not found, no include::{snippetDir}application-link/PUT/http-response.adoc[opts=optional]



// file not found, no * wiremock data link :application-link/PUT/PUT.json[]


ifdef::internal-generation[]
===== Implementation

// markup not found, no include::{specDir}application-link/PUT/implementation.adoc[opts=optional]
