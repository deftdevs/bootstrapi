...
class AuthenticationServiceTest {
    ...
    void testGetAuthenticationSso() {
        ...
        assertEquals(ssoConfig.getShowLoginFormForJsm(), authenticationSsoModel.getShowOnLoginForJsm());
    ...
    void testSetAuthenticationSso() {
        ...
        final SsoConfig ssoConfig = ImmutableSsoConfig.builder()
                ...
                .setShowLoginFormForJsm(authenticationSsoModel.getShowOnLoginForJsm())
        ...
        assertEquals(authenticationSsoModel.getShowOnLoginForJsm(), resultAuthenticationSsoModel.getShowOnLoginForJsm());
