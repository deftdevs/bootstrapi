...
import static com.deftdevs.bootstrapi.jira.model.util.ApplicationLinkBeanUtil.toApplicationLinkBean;
...
public class ApplicationLinkServiceImpl implements ApplicationLinksService {
    ...
    public Collection<ApplicationLinkBean> setApplicationLinks(
            final Collection<ApplicationLinkBean> applicationLinkBeans,
